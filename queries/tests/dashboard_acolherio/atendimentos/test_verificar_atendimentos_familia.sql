/*
 Este teste verifica se todos os atendimentos do módulo família 
...
/*
    ...
    stg_atendimentos_familias, o seqatend_modulo fica null. 
*/
with tabela_base as (
select
    a.seqatend_modulo,
